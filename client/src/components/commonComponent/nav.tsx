...
const Nav: React.FC = () => {
    ...
    const [flag, setflagg] = useState(-1);
    useEffect(() => {
        if(pathname==='/dashboard'){
            setflagg(0);
        }else if(pathname==='/settings'){
            setflagg(1);
        }else if(pathname==='/addsection'){
            setflagg(2);
        }
    }, []);
    ...
    return (
        <Flex
            ...
            transform={windowSize > 769 ? "translateX(0%)" : navshow === false ? "translateX(-100%)" : "translateX(0%)"}
