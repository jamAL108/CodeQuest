...
const Activities: React.FC = () => {
  ...
  useEffect(() => {
    if (userState?.sections && userState.sections.length !== 0) {
      setdata(userState.sections);
      setdatatoshow(userState.sections);
    }
  }, [userState?.sections])
  ...
  return (
    <Flex w='100vw' h='100vh' overflow='hidden' fontFamily='Poppins , sans-serif' className="dashboard">
      ...
      <Flex className="text-white" overflow='hidden' w={{ base: "100%", md: '80%' }} h='100vh' bg='#202029' justify='flex-start' align='center' direction='column' userSelect='none' borderLeft='1px solid #23232B'  >
        <Flex
          height="5.5rem"
          width="92%"
          alignItems="center"
              ...
              >
                {datatoshow && datatoshow.length !== 0 ? (
                  datatoshow
                    ...
                    .map((item, idx) => (
                      <Flex
                        borderBottom='0.5px solid #38383d'
                        w={{ md: "full" }}
