    ...
    >
      ...
      >
        ...
        >
          ...
          <Flex w="full" h={{base:'5rem',md:"2rem"}} gap={{base:'25px',md:"40px"}} direction={{base:'column',md:'row'}} >
            ...
            <Flex mt={0} w="280px" h={{base:'2.5rem',md:"2rem"}}  gap="10px" >
              ...
              >
                Already an Member ?
                <p className="text-[#6336a8] hover:scale-[1.06] hover:underline cursor-pointer text-[0.9rem] transition-[0.5] duration-[ease-in-out]" 
                  onClick={(e) => {
                    e.preventDefault();
        ...
        <Center pos="absolute" bottom="10" left="10" fontSize='1.15rem' fontWeight={550} gap='10px'>
          <p className="text-[#FF0000] text-[1.15rem] font-[550] gap-[10px] flex">{error ? <ErrorOutlineIcon /> : ""} {error}</p>
        </Center>
        ...
        >
          ...
          base:px-[26px] md:px-[14px] rounded-[6px] base:text-[1rem] md:text-[0.85rem] font-[550] transition-[0.5] duration-[ease] cursor-pointer hover:bg-[#6336a8] hover:scale-[1.04)" 
          onClick={check}
          >
            Create An Account
          </button>
